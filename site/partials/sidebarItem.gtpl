...
def iconMap = [
    'index': '<svg viewBox="0 0 24 24"><path d="M4 11.5L12 5l8 6.5" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path><path d="M6.5 10.5V19h11v-8.5" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"></path></svg>',
